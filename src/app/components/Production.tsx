          ...
          <div className="production-items">
            ...
            <Btn>
              <ProductionItem
                ...
                pES="Según se haya ajustado y aprobado el guion de grabación, procedemos a organizar el rodaje: fechas, selección de los modelos, presentadores o entrevistados, selección y adecuación de locaciones, preparación de o de los productos. Una vez preparada la grabación el equipo técnico y humano se cita en la locación escogida y se graban los planos propuestos según el guion aprobado, en este proceso participan director, camarógrafo, productor, asistente de luces y asistente de sonido. (en ocasiones y según la necesidad pueden intervenir mas personas: maquillaje, vestuarista, diseñador de dummies)."
